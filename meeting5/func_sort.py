...
print(sorted([3, 1, -5, 6, 9]))
print(sorted([3, 1, -5, 6, 9], reverse=True))
...
pprint(sorted(students, key=lambda s: s['grade']))
pprint(sorted(students, key=lambda s: s['name']))
...
print((2, "apple") < (2, "ty"))
print((3, "apple") < (2, "ty"))
# print((2, 6, None) < (2, 6, 7))

pprint(
    sorted(
        students, key=lambda s: (s['grade'], s['name'])
    ))
# a
# ape
# apple
